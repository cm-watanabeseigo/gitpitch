...
ブログが書けなくて四半期ごとに夜な夜なおびえている CM 社員が「**ああこんな書き方してても大丈夫なやつがいるんだ**」と解放された気分で朝を迎えることができるようになること
...
---?image=assets/img/IMG_1909.JPG&position=bottom&size=80%
### 道具(ハードウェア)
...
- Visual Studio Code エディタ
  - Backspace++ / Japanese Word Handler / join-line / Markdown All In One / vscode-memo-life-for-you / Zenkaku
...
- 実際の手順（長くなりがち）
- この機能の背景：なぜこれが要るのか、どういう時にうれしいのかの考察
- 注意点：これをすることで/しないことで発生する不利益について
- 脚注
@ulend

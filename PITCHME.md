...
第7回このサービスは俺に聞け勉強会  
@color[glay](@size[0.6em](というか聞いて下さいお願いします))
...
※状況に応じてMXやメール配信・Virus Checkなどが入ってくる
...
|            入力             |             説明              |                                   SMTPサーバ側の処理                                    |
| :-------------------------- | :---------------------------- | :-------------------------------------------------------------------------------------- |
| nc localhost 25             | (接続コマンド)                | どんなIPアドレスから繋いできたか、<br/>逆引きはあるか、<br/>ブラックリスト、Glaylisting |
...
| 25/tcp通信が許可される範囲の限定                                    | IP25B                            |
| `HELO` で名乗ったホスト名は適切か、<br/>DNS逆引きと齟齬が無いか     |                                  |
| SMTP/ESMTPプロトコルに適切に従っているか                            | Dropする                         |
| 無条件に接続を切ってみて相手は再送してくるか                        | Glaylisting                      |
